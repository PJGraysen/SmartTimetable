...
def test_missing_teacher_assignment_is_infeasible():
    """A requirement with no eligible teacher cannot be scheduled."""
...
def test_inactive_teacher_assignment_is_ignored():
    """An inactive teacher assignment cannot make a teacher eligible."""
...
def test_inactive_teacher_cannot_be_scheduled():
    """An inactive teacher cannot receive a lesson assignment."""
