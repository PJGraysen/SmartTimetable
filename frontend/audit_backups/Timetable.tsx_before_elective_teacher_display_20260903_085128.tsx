                        ...
                        >
                          {isMondayAssembly ? (
                            ...
                            slotEntries.map((entry) => {
                              ...
                              const subjectCode = lesson.code.toUpperCase();

                              const matchedElective = isGrade10
                                ? Object.entries(electiveSubjects).find(
                                    ([, subjects]) =>
                                      subjects.includes(subjectCode),
                                  )
                                : undefined;

                              const displayedSubjects = matchedElective
                                ? matchedElective[1].join(" · ")
                                : lesson.code ||
                                  lesson.name ||
                                  "SUBJECT";

                              const displayedOption = matchedElective
                                ? matchedElective[0]
                                : lesson.elective;
