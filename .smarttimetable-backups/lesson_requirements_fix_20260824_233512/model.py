...
class SolverModelBuilder:
        ...
        *,
        ...
        for requirement in problem.lesson_requirements:
            ...
            for (
                slot_key,
                slot_variables,
            ) in variables_by_requirement_slot.items():

                if slot_key[0] != requirement.id:
                    continue
    ...
    # ============================================================
    # SIMULTANEOUS OPTION CONSTRAINTS
    # ============================================================
    ...
    def _add_simultaneous_option_constraints(
        ...
        *,
        ...
        """
        Synchronize Grade 10 simultaneous option subjects.

        Subjects in one configured block must occupy exactly the
        same day/period pattern.

        Teachers and rooms remain independent.
        """
        ...
        for requirement in problem.lesson_requirements:
            ...
            members = (
                requirements_by_block.setdefault(
                    key,
                    {},
                )
            )

            if subject_code not in members:
                members[subject_code] = (
                    requirement
                )
        ...
        for (
            instructional_group_id,
            block,
        ), members in requirements_by_block.items():
            ...
            if len(frequencies) != 1:
                raise ValueError(
                    "Simultaneous Grade 10 option block has "
                    "mismatched weekly lesson counts: "
                    f"group={instructional_group_id}, "
    ...
    def _add_group_clash_constraints(
        ...
        *,
        ...
        Simultaneous option members are intentionally exempt because
        they are required to occupy the same student timetable slot.
        """
